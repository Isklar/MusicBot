...
class MusicBot(discord.Client):
    ...
    async def handle_pause(self, player, channel, author):
        """
    ...
    async def handle_resume(self, player, channel, author):
        """
    ...
    async def handle_shuffle(self, player, channel, author):
        """
    ...
    async def handle_volume(self, message, channel, author, new_volume=None):
        """
